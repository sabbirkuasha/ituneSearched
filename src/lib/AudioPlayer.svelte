<script>
    export let trackName = "Song or track Name"
    export let albumName = "Album Name"
    export let artistName = "Artist Name"
    export let artworkurl = "https://tailwindcss.com/img/card-top.jpg"
    export let trackpreviewUrl = "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview115/v4/0a/11/d7/0a11d7dd-bb3b-a556-827c-b652dc89894f/mzaf_11506359827593655660.plus.aac.p.m4a"
...
<div class="w-full overflow-x-hidden">
    <div class="h-2 bg-red-light"></div>
      <div class="flex items-center justify-center h-1/2">
          <div  class="bg-slate-600 w-auto shadow-lg rounded-lg" 
                >
              <div class="flex">
                  <div class="p-5 bg-slate-800 flex flex-col justify-center">
                      <img class="w-60 rounded block" src={artworkurl} alt={albumName}>
                  </div>
                  <div class="w-full p-8">
                      <div class="flex justify-between">
                          <div>
                              <h3 class="text-2xl text-grey-darkest font-medium">{trackName}</h3>
                              <p class="text-sm text-grey mt-1">{artistName}</p>
                          </div>
                      ...
                      <div class="flex justify-between items-center mt-8">
                          ...
                          <div on:click={"document.getElementById('player').play()"} class="text-white p-8 rounded-full bg-red-900 shadow-lg">
              ...
              <div class="mx-8 py-4">
                  <div class="flex justify-between text-sm text-grey-darker mb-2">
                    <p>0:40</p>
					<p>4:20</p>
                    <audio>
                  ...
                  <div class="mt-1">
                      <div class="h-1 bg-red-100 rounded-full">
                          <div class="w-1/5 h-1 bg-red-600 rounded-full relative">
                              <span class="w-4 h-4 bg-red-900 absolute pin-r pin-b ring-2 ring-red-300 -mt-1.5 rounded-full shadow"></span>
                          </div>
                      </div>
                  </div>
              </div>
